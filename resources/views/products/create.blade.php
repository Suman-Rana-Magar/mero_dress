...
<div style="margin-top: 10px; border-style: groove; border-radius: 20px;">
    <form method="post" action="{{route('products.store')}}" enctype="multipart/form-data">
        ...
        <div class="mb-3" id="input-field">
            ...
            <input type="number" class="form-control @error('cost') is-invalid @enderror" id="cost" aria-describedby="emailHelp" name="cost_price" value="{{old('cost_price')}}">
            @error('cost')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
        ...
        <div class="mb-3" id="input-field">
            ...
            <input type="number" class="form-control @error('selling') is-invalid @enderror" id="selling" name="selling_price" value="{{old('selling_price')}}">
            @error('selling')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
