...
@section('body')
    <div class='container mt-5'>
        ...
        @endif
        <div class='card'>
            <a href='{{ route('products.index') }}' style='margin-left: 20px; color: black; '><i
                ...
                <div class='main col-md-6'>
                    <div class=' mb-4 mt-4'>
                        ...
                        <div class='price d-flex flex-row align-items-center'> <span
                                ...
                                class='act-price'><b>Rs.{{ $product->selling_price }}</b></span>
                        </div>
                        ...
                        @if (Auth::user())
                            <div class='cart mb-4'>
                                <input type='submit' id='addCart'
                                    class="btn btn-danger @error('login') is-invalid @enderror" value='ADD TO CART'>
                            </div>
                        @else
                            <div class='cart mb-4'>
            ...
            <div class="card mt-2" style="margin-bottom: 10px;">
                ...
                <div class="contents">
                    <div class="totalRating">
                        ...
                        <div class>
                            @if ($totalReviews <= 2)
                                <img class="image" src="{{ asset('images/angry.png') }}" alt="angry" height="150"
                                    width="auto">
                            @elseif($totalReviews > 2 && $totalReviews <= 4)
                                <img class="image" src="{{ asset('images/slightly_angry.png') }}" alt="slightly_angry"
                                    height="150" width="auto">
                            @elseif($totalReviews > 4 && $totalReviews <= 6)
                                <img class="image" src="{{ asset('images/none.png') }}" alt="none" height="150"
                                    width="auto">
                            @elseif($totalReviews > 6 && $totalReviews <= 8)
                                <img class="image" src="{{ asset('images/slightly_happy.png') }}" alt="slightly_happy"
                                    height="150" width="auto">
                            @else
                                <img class="image" src="{{ asset('images/happy.png') }}" alt="Happy" height="150"
                                    width="auto">
                            @endif
                        ...
                        @foreach ($reviews as $review)
                            ...
                            <div class="allReviews">
                                ...
                                <p style="font-size: 12.5px; color: #404040; margin-bottom: 5px;">by {{ $userName }}
                                </p>
