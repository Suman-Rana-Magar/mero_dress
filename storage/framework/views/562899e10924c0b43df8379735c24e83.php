<?php $__env->startSection('title','Product | Search'); ?>
<style>
    .image-container
    {
        width: auto;
...
<div style="margin-left: 40px; height: 40px; width: 100%; margin-bottom: -20px;">
    <p style="font-size: 20px; font-weight: bold; color: yellow; cursor: default">Search>"<?php echo e($search); ?>"</p>
</div>
<?php if($searchedProducts->isNotEmpty()): ?>

<?php $__currentLoopData = $searchedProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
<div id="paginate">
<?php echo e($searchedProducts->withQueryString()->links()); ?>

</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('/layouts/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/suman/mero_dress/resources/views/products/search.blade.php ENDPATH**/ ?>