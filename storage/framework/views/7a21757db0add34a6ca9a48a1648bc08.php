...
<body>
    <div style="width: 50%; border-style: groove; margin: 20px 25%; border-radius: 25px; background-color: #f0f0f0;">
        <form method="post" action="<?php echo e(route('users.updatePassword',Auth::user()->id)); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="oldPassword" name="oldPassword" value="<?php echo e(old('oldPassword')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="newPassword" name="newPassword" value="<?php echo e(old('newPassword')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="reNewPassword" name="newPassword_confirmation" value="<?php echo e(old('newPassword_confirmation')); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="submit">
            <a href="<?php echo e(route('users.cancel')); ?>"><button class="btn btn-secondary">Cancel</button></a>
        </div>
    </div>
</body>

</html><?php /**PATH /home/suman/mero_dress/resources/views/users/changePassword.blade.php ENDPATH**/ ?>