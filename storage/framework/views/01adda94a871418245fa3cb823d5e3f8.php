...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="submit">
            <a href="<?php echo e(route('users.changePassword')); ?>"><button class="btn btn-info" title="Edit Password"><i class="fa-solid fa-key"></i></button></a>
            <a href="<?php echo e(route('users.cancel')); ?>"><button class="btn btn-secondary">Cancel</button></a>
        </div>
    </div>
</body>

</html><?php /**PATH /home/suman/mero_dress/resources/views/users/edit.blade.php ENDPATH**/ ?>