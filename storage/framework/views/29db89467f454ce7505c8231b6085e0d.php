                            ...
                            <div class="card-body p-5">
                                ...
                                <form method="post" action="<?php echo e(route('users.store')); ?>" enctype="multipart/form-data">
                                    ...
                                    <div class="form-outline mb-4">
                                        ...
                                        <input type="text" id="form3Example1cg" class="form-control form-control-lg <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-outline mb-4">
                                        ...
                                        <input type="password" id="form3Example4cdg" class="form-control form-control-lg" name="password_confirmation" value="<?php echo e(old('password_confirmation')); ?>" />
                                    </div>
                                    ...
                                    <p class="text-center text-muted mt-5 mb-0">Have already an account? <a href="#!" class="fw-bold text-body"><a href="<?php echo e(route('users.index')); ?>"><u>Login here</u></a></a></p>
...
</html><?php /**PATH /home/suman/mero_dress/resources/views/users/create.blade.php ENDPATH**/ ?>